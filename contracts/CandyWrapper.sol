...
contract CandyWrapper is ERC721A, Ownable, ReentrancyGuard {
     ...
     */
    function indexFromTokenID(uint16 value) private view returns (uint16) {
            ...
            'viewBox="0 0 800 800" style="enable-background:new 0 0 800 800;" xml:space="preserve">',
                ...
                '<g class="floating">',
                    ...
                    '<g class="floatingdelay" style="opacity: ',candyCollection.reveal ?'1':'0',';">',
                        ...
                        '<tspan x="0" y="20" class="st7 st8">',candyCollection.descriptorB[tokenId % 2 ? index : indexFromTokenID(index)],'</tspan>',
                        ...
                        '<tspan x="0" y="120" class="st7 st8" style="font-size: 18px;">DAOs Registered: 0</tspan>',
                        '<tspan x="0" y="140" class="st7 st8" style="font-size: 14px; fill: none;">[ ',bytesToBinaryString(candyFeatures[0]),' ',bytesToBinaryString(candyFeatures[1]),' ',bytesToBinaryString(candyFeatures[2]),' ]</tspan>',
                        '<tspan x="0" y="140" class="st7 st8" style="font-size: 14px; fill: none;">[ ',bytesToBinaryString(candyFeatures[3]),' ',bytesToBinaryString(candyFeatures[4]),' ',bytesToBinaryString(candyFeatures[5]),' ]</tspan>',
                        '</text>',
                    '</g>',
                ...
                '<defs>',
                    '<linearGradient id="darkGradient" x1="30%" y1="70%">',
                        ...
                        '  <animate attributeName="stop-color" values="', candyCollection.reveal ? getBackground[tokenId][0]:'#000000','; #', candyCollection.reveal ? getBackground[tokenId][0]:'#ffffff',';" dur="1.5s" repeatCount="1" fill="freeze"/>',
                        '</stop>',
                        '<stop offset="100%" stop-color="', candyCollection.reveal ? getBackground[tokenId][0]:'#ffffff','">',
                        '  <animate attributeName="stop-color" values="', candyCollection.reveal ? getBackground[tokenId][0]:'#ffffff','; ', candyCollection.reveal ? getBackground[tokenId][0]:'#000000','" dur="3s" fill="freeze" />',
                        '</stop>',
                    '</linearGradient>',
                '</defs>',
            '</svg>'
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                ...
                '"description": "Candy",',
                '"image": "', wrappedCandy(tokenId), '"', //do conditional baseUri here ownerTokenIdToIndex[msg.sender][tokenId]
                '"attributes": [',
                    '{',
                        '"trait_type": "Name",',
