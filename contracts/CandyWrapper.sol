    ...
    */
    ...
    function wrappedCandy(uint16 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '				<tspan x="0" y="-20.2" class="st7 st8">',candyCollection.descriptorA,'</tspan>',
            '				<tspan x="0" y="20" class="st7 st8">',candyCollection.descriptorB,'</tspan>',
            '				<tspan x="0" y="63.2" class="st7 st8">',candyCollection.descriptorC,'</tspan>',
